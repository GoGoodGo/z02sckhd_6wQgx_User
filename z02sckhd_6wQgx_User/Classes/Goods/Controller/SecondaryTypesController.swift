...
class SecondaryTypesController: UIViewController {
    ...
    private func setupUI() {
        ...
        typeCollectionView.register(UINib.init(nibName: CellName(SecondaryTypeCell.self), bundle: nil), forCellWithReuseIdentifier: CellName(SecondaryTypeCell.self))
        goodsCollectionView.register(UINib.init(nibName: CellName(RecommendGoodsCell.self), bundle: nil), forCellWithReuseIdentifier: CellName(RecommendGoodsCell.self))
