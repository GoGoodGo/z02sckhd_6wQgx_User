...
class WithdrawRecordController: UIViewController {
    ...
    private func setupUI() {
        ...
        tableView.register(UINib.init(nibName: CellName(WithdrawRecordCell.self), bundle: nil), forCellReuseIdentifier: CellName(WithdrawRecordCell.self))
    ...
    @objc func action_withdraw() {
        ...
        let applyWithdraw = ApplyWithdrawController()
